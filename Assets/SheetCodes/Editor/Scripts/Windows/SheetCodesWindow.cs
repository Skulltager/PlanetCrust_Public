...
namespace SheetCodesEditor
{
    public class SheetCodesWindow : EditorWindow
    {
        ...
        static bool WantsToQuit()
        {
            ...
            SheetCodesWindow window = windows[0];
            if(window.ContainsChanges() && EditorUtility.DisplayDialog(Localization.UNSAVED_CHANGES_TITLE, Localization.UNSAVED_CHANGESLOST_MESSAGE, Localization.YES, Localization.NO))
            {
        ...
        private static void CloseWindowOnReload()
        {
            ...
            SheetCodesWindow sheetCodesWindow = windows[0];
        ...
        private void DrawButtonRow_NoSheet()
        {
            ...
            EditorGUI.DrawRect(taskbarRect, backgroundColor);
