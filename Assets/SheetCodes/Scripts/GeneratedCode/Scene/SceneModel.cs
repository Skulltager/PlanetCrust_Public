...
namespace SheetCodes
{
	...
	[Serializable]
	public class SceneModel : BaseModel<SceneRecord, SceneIdentifier>
	{
		[SerializeField] private SceneRecord[] records = default;
		protected override SceneRecord[] Records { get { return records; } }
