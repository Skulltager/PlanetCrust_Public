...
public class HUDArmorBar : DataDrivenUI<ShipData_Health>
{
    [SerializeField] private Text armorAmount = default;
    ...
    private void UpdateBar()
    {
        ...
        armorAmount.text = string.Format("{0} / {1}", data.armor.value, data.maxArmor.value);
    }
}
